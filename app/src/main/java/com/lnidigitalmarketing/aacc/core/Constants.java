...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.lnidigitalmarketing.aacc";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "Asian Chamber";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.lnidigitalmarketing.aacc.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.lnidigitalmarketing.aacc.";
